...
// Botões de resetar os valores para melhor praticidade e facilidade
	render () {
		return (
			<div className="body">
				<Header />				
				<Settings setPayRate={this.setPayRate} setMultiplier={this.setMultiplier} />				
				<button className="clearBtn" onClick={this.clearSettings}>Zerar Valores</button>
				<ShiftTimes
				...
				/>
				<button className="resetBtn" onClick={this.resetState}>Zerar Tempos</button>
